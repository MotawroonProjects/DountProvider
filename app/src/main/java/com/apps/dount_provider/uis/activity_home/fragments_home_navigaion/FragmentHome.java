package com.apps.dount_provider.uis.activity_home.fragments_home_navigaion;
...
import com.apps.dount_provider.adapter.CurrentOrderAdapter;
import com.apps.dount_provider.model.OrderModel;
import com.apps.dount_provider.mvvm.FragmentHomeMvvm;
...
public class FragmentHome extends BaseFragment {
    ...
    private void initView() {
        ...
        fragmentHomeMvvm.getOrder(getUserModel().getData().getApi_token());
        binding.swipeRefresh.setOnRefreshListener(() -> fragmentHomeMvvm.getOrder(getUserModel().getData().getApi_token()));
